...
st.set_page_config(page_title="เซียมซี", page_icon="💖")
...
# --- 5. ส่วนแสดงผลบนเว็บ ---
st.markdown("<div class='title-text'>💖 เซียมซี ทำนายใคร 💖</div>", unsafe_allow_html=True)
...
if st.button("🌸 กดเพื่อเสี่ยงเซียมซี"):
    ...
    with animation_area.container():
        ...
        status_text.markdown("<p class='status-text'>อธิษฐานถึงคนในใจ อย่าเพิ่งหลับนะ</p>", unsafe_allow_html=True)
        time.sleep(1)
